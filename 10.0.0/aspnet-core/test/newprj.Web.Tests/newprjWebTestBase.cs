...
public abstract class newprjWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static newprjWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(newprjWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<newprjDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<newprjDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<newprjDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<newprjDbContext, Task<T>> func)
    {
        T result;
