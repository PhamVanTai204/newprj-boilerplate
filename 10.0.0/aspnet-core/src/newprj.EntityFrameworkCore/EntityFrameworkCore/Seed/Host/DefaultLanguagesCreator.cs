...
namespace newprj.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly newprjDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = newprjConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(newprjDbContext context)
    {
        _context = context;
    }
