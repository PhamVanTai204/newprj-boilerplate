...
namespace newprj.Migrations
{
    ...
    partial class newprjDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newprj.Entities.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newprj.Entities.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newprj.Entities.InvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newprj.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("newprj.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("newprj.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("newprj.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("newprj.Entities.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("newprj.Entities.InvoiceItem", b =>
                {
                    b.HasOne("newprj.Entities.Invoice", "Invoice")
